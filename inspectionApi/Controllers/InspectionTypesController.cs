...
namespace InspectionAPI.Controllers
{
    ...
    public class InspectionTypesController : ControllerBase
    {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<InspectionTypes>> GetInspectionType(int id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutInspectionType(int id, InspectionTypes inspectionType)
        {
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<InspectionTypes>> PostInspectionType(InspectionTypes inspectionType)
        {
